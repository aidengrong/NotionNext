...
const BLOG = {
  ...
  KEYWORDS: 'aidengrong, 博客', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'bd1e9d3dfdfac77081dfafa6270d98f7', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
